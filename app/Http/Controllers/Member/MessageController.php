...
class MessageController extends Controller
{
    ...
    public function download(Request $request, MessageAttachment $attachment, ChatService $chat)
    {
        ...
        $disk = $chat->attachmentDiskFor($attachment->file_path);
        abort_unless($disk, 404);

        return Storage::disk($disk)->download($attachment->file_path, $attachment->file_name ?? basename($attachment->file_path));
    }
