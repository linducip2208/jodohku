...
.ld-logo{font-weight:800;font-size:22px;text-decoration:none;color:#18181b}.ld-logo span{background:linear-gradient(135deg,#f43f5e,#ec4899,#8b5cf6);-webkit-background-clip:text;background-clip:text;color:transparent}
...
.ld-btn{display:inline-block;background:linear-gradient(135deg,#f43f5e,#ec4899);color:#fff;font-weight:700;padding:11px 22px;border-radius:999px;text-decoration:none;font-size:14px;border:0}
...
<div><div style="color:#fff;font-weight:700;margin-bottom:10px">Bantuan</div><div><a href="#faq">FAQ</a></div><div><a href="/safety">Pusat Keamanan</a></div><div><a href="/verification">Verifikasi</a></div></div>
<div><div style="color:#fff;font-weight:700;margin-bottom:10px">Legal</div><div><a href="/safety">Syarat &amp; Ketentuan</a></div><div><a href="/safety">Privasi</a></div></div>
</div>
