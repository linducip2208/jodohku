...
@foreach ([
    ...
    ['label' => 'Match rate', 'value' => $metrics['match_rate'].'%', 'ti' => 'ti-chart-line'],
    ['label' => 'Taaruf aktif', 'value' => $metrics['taaruf_active'], 'ti' => 'ti-route'],
    ['label' => 'Taaruf selesai', 'value' => $metrics['taaruf_completed'], 'ti' => 'ti-flag-check'],
    ['label' => 'Konsultasi', 'value' => $metrics['consultations'], 'ti' => 'ti-headset'],
